...
from utility.QuasarModelRaw.gauss import Gaussian, GaussList, limit_angle
from utility.QuasarModelRaw.get_data import get_data
import scipy
...
class SourceModel:
    ...
    def process(self, path):
        ...
        x_l, y_l, intensity_l = get_data(path)
        gauss_fnd = GaussList()
